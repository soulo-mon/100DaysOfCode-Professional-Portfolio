...
def information():
    ...
    name = Label(window2, bg="green",
                 text=" 'Cross(X)'----For First Player \n\n\n\n 'Circle(O)' ----For second player\n\n\nPlease click on 'X' or 'O' at first \n\nthen write the input box number",
                 fg="red",
    ...
    ok_button = Button(window2, width="5", bg="black", fg="red", font=("arial", 20, "bold"), text="OK", relief=RAISED,
                       bd=8,
                       command=tata)
...
but_circle = Button(window, width="3", text="O", bg="black", fg="green", font=("arial", 15, "bold"),
                    command=input_box_number_circle, relief=RAISED, bd=8)
